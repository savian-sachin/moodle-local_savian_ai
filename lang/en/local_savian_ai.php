...
$string['privacy:metadata:writing_submissions'] = 'Writing submissions';
$string['privacy:metadata:writing_submissions:feedback_json'] = 'AI feedback results';
$string['privacy:metadata:writing_submissions:moodle_user_id'] = 'Moodle user ID';
$string['privacy:metadata:writing_submissions:timecreated'] = 'Time submitted';
$string['privacy:metadata:writing_submissions:word_count'] = 'Word count';
$string['privacy:metadata:writing_tasks'] = 'Writing tasks created by the teacher';
$string['privacy:metadata:writing_tasks:course_id'] = 'Course ID';
$string['privacy:metadata:writing_tasks:teacher_user_id'] = 'Teacher user ID';
$string['privacy:metadata:writing_tasks:timecreated'] = 'Time created';
$string['privacy:metadata:writing_tasks:title'] = 'Task title';
...
$string['tutorial_writing_cefr_desc'] = 'Each submission is assessed against the CEFR scale (A1–C2). The AI gives a level, a reasoning paragraph, identified strengths, grammar errors, and an improved version of the text.';
$string['tutorial_writing_cefr_grades'] = 'CEFR grades map to Moodle gradebook scores: A1=1, A2=2, B1=3, B2=4, C1=5, C2=6 (out of 6.0)';
$string['tutorial_writing_cefr_heading'] = 'CEFR / IELTS Scoring Explained';
$string['tutorial_writing_cefr_ielts'] = 'For IELTS exam types the AI returns four band scores (Task Achievement, Coherence & Cohesion, Lexical Resource, Grammatical Range & Accuracy) plus an overall band out of 9.0.';
$string['tutorial_writing_cefr_target'] = 'Set a <strong>Target CEFR Level</strong> when creating the task so the AI calibrates its feedback to that proficiency goal.';
$string['tutorial_writing_create_step1'] = 'Navigate to your course and click <strong>Savian AI</strong> in the course navigation.';
...
$string['tutorial_writing_create_step4'] = 'Fill in: Title, Writing Prompt, Task Type (Essay/Letter/Email/Report/Review/Story), Language, Exam Type, Target CEFR Level, and optional min/max word counts.';
$string['tutorial_writing_create_step5'] = 'Tick <strong>Include AI-Improved Writing</strong> if you want students to receive a corrected version of their text alongside the feedback.';
$string['tutorial_writing_create_step6'] = 'Click <strong>Create Task</strong>. The task is synced with the AI service and immediately available to students.';
$string['tutorial_writing_create_title'] = 'Part 1 (Teacher): Creating a Writing Task';
$string['tutorial_writing_desc'] = 'Create AI-assessed writing tasks, submit writing for instant feedback, and understand CEFR/IELTS scoring and gradebook integration.';
$string['tutorial_writing_gradebook_desc'] = 'Each writing task automatically creates a grade item in the Moodle gradebook. Grades are written when a student receives feedback.';
$string['tutorial_writing_gradebook_heading'] = 'Part 4: Gradebook Integration';
$string['tutorial_writing_gradebook_ielts'] = '<strong>IELTS tasks</strong>: overall band score (0.0 – 9.0) is recorded directly as the grade.';
$string['tutorial_writing_gradebook_max'] = 'Max grade is <strong>9.0</strong> for IELTS exam types and <strong>6.0</strong> for all CEFR-based types.';
$string['tutorial_writing_gradebook_note'] = 'Deleting a task also removes its gradebook item. Only the most recent submission grade is kept in the gradebook.';
$string['tutorial_writing_gradebook_standard'] = '<strong>CEFR tasks</strong>: the CEFR level maps to a numeric grade (A1=1 … C2=6) which is written to the gradebook.';
$string['tutorial_writing_gradebook_view'] = 'Teachers can view all grades in the standard Moodle Gradebook (Course → Grades) as well as via the Writing Practice class report.';
$string['tutorial_writing_submit_feedback'] = 'The AI returns: CEFR level, reasoning, strengths, grammar/spelling notes, areas for improvement, and (if enabled) an AI-improved version of the text.';
$string['tutorial_writing_submit_grade'] = 'Your grade (CEFR score or IELTS band) is automatically recorded in the Moodle gradebook.';
$string['tutorial_writing_submit_step1'] = 'Navigate to your course, click <strong>Savian AI</strong> then <strong>Writing Practice</strong>.';
...
$string['tutorial_writing_submit_step4'] = 'Click <strong>Submit Writing</strong>. The AI takes 8–15 seconds to analyse your text.';
$string['tutorial_writing_submit_step5'] = 'Review your feedback on screen. Return any time via <strong>View your last feedback</strong>.';
$string['tutorial_writing_submit_tip'] = 'Re-read the prompt before submitting. The AI checks whether your response actually addresses the task, so staying on-topic raises your score.';
$string['tutorial_writing_submit_title'] = 'Part 2 (Student): Submitting Writing and Getting AI Feedback';
$string['tutorial_writing_tip'] = 'Combine Writing Practice with the Chat tutor: after receiving feedback, students can ask the chat tutor to explain any grammar point or vocabulary suggestion.';
...
$string['writing_practice'] = 'Writing Practice';
$string['writing_practice_api_error'] = 'Writing task could not be created. Please check your API configuration or try again.';
$string['writing_practice_atrisk'] = 'At-Risk Students';
$string['writing_practice_atrisk_desc'] = 'Students who may need intervention based on their writing performance.';
$string['writing_practice_card_desc'] = 'Create AI-assessed writing assignments with CEFR and IELTS scoring.';
$string['writing_practice_cefr_level'] = 'CEFR Level';
$string['writing_practice_cefr_reasoning'] = 'Assessment Reasoning';
$string['writing_practice_class_report'] = 'Class Report';
$string['writing_practice_create_task'] = 'Create Writing Task';
$string['writing_practice_delete_task'] = 'Delete Task';
$string['writing_practice_exam_type'] = 'Exam Type';
$string['writing_practice_exam_type_cambridge_b1'] = 'Cambridge B1';
$string['writing_practice_exam_type_cambridge_b2'] = 'Cambridge B2';
$string['writing_practice_exam_type_general'] = 'General';
$string['writing_practice_exam_type_ielts_task1'] = 'IELTS Task 1';
$string['writing_practice_exam_type_ielts_task2'] = 'IELTS Task 2';
$string['writing_practice_feedback_heading'] = 'Your AI Feedback';
$string['writing_practice_grammar_errors'] = 'Grammar & Spelling';
$string['writing_practice_has_feedback'] = 'You have a completed assessment.';
$string['writing_practice_ielts_coherence'] = 'Coherence & Cohesion';
$string['writing_practice_ielts_grammar'] = 'Grammatical Range & Accuracy';
$string['writing_practice_ielts_lexical'] = 'Lexical Resource';
$string['writing_practice_ielts_outof'] = 'out of 9.0';
$string['writing_practice_ielts_overall'] = 'Overall Band Score';
$string['writing_practice_ielts_scores'] = 'IELTS Band Scores';
$string['writing_practice_ielts_task_response'] = 'Task Achievement';
$string['writing_practice_improved_writing'] = 'AI-Improved Version';
$string['writing_practice_improvements'] = 'Areas for improvement';
$string['writing_practice_include_improved'] = 'Include AI-Improved Writing';
$string['writing_practice_language'] = 'Language';
$string['writing_practice_manage_tasks'] = 'Manage Writing Tasks';
$string['writing_practice_no_tasks'] = 'No writing tasks yet. Create one to get started.';
$string['writing_practice_polling_desc'] = 'Your writing is being analysed by AI. This takes 8-15 seconds.';
$string['writing_practice_polling_heading'] = 'Analysing Your Writing...';
$string['writing_practice_prompt'] = 'Writing Prompt';
$string['writing_practice_prompt_placeholder'] = 'E.g. Write an essay of 200–300 words discussing the advantages and disadvantages of social media. State your opinion and support it with examples.';
$string['writing_practice_risk_factors'] = 'Risk Factors';
$string['writing_practice_select_task'] = 'Select a Writing Task';
$string['writing_practice_strengths'] = 'Strengths';
$string['writing_practice_submission_count'] = 'Submissions';
$string['writing_practice_submit'] = 'Submit Writing';
$string['writing_practice_target_cefr'] = 'Target CEFR Level';
$string['writing_practice_task_invalid'] = 'Not synced';
$string['writing_practice_task_not_synced'] = 'This task is not properly synced with the AI service. Please ask your teacher to delete it and create a new one.';
$string['writing_practice_task_type'] = 'Task Type';
$string['writing_practice_task_type_email'] = 'Email';
$string['writing_practice_task_type_essay'] = 'Essay';
$string['writing_practice_task_type_letter'] = 'Letter';
$string['writing_practice_task_type_report'] = 'Report';
$string['writing_practice_task_type_review'] = 'Review';
$string['writing_practice_task_type_story'] = 'Story';
$string['writing_practice_timeout'] = 'Assessment timed out. Please try again.';
$string['writing_practice_title_placeholder'] = 'E.g. Opinion Essay — Advantages of Technology';
$string['writing_practice_view_last_feedback'] = 'View your last feedback';
$string['writing_practice_word_count_max'] = 'Maximum Word Count';
$string['writing_practice_word_count_min'] = 'Minimum Word Count';
$string['writing_practice_your_grade'] = 'Your Grade';
$string['writing_practice_your_writing'] = 'Your Writing';
